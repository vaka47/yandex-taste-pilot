...
export const fixtureEvents: ListeningEvent[] = [
  {
    ...
    observedAt: minutesAgo(7), fetchedAt: minutesAgo(5), publishAt: minutesAgo(5), visibility: "public", hiddenReason: null, playCount7d: 4, firstSeenAt: daysAgo(18)
  },
  {
    id: "evt-air-kyoto",
    ...
    observedAt: minutesAgo(42), fetchedAt: minutesAgo(40), publishAt: minutesAgo(40), visibility: "public", hiddenReason: null, playCount7d: 2, firstSeenAt: daysAgo(3)
  },
  {
    ...
    observedAt: minutesAgo(96), fetchedAt: minutesAgo(94), publishAt: minutesAgo(94), visibility: "public", hiddenReason: null, playCount7d: 6, firstSeenAt: daysAgo(11)
  },
  {
    ...
    observedAt: minutesAgo(184), fetchedAt: minutesAgo(181), publishAt: minutesAgo(181), visibility: "public", hiddenReason: null, playCount7d: 3, firstSeenAt: daysAgo(1)
  },
  {
    id: "evt-oqjav-son",
    ...
    observedAt: daysAgo(1), fetchedAt: daysAgo(1), publishAt: daysAgo(1), visibility: "public", hiddenReason: null, playCount7d: 2, firstSeenAt: daysAgo(29)
  },
  {
    id: "evt-saluki-ogney",
    ...
    observedAt: daysAgo(2), fetchedAt: daysAgo(2), publishAt: daysAgo(2), visibility: "public", hiddenReason: null, playCount7d: 1, firstSeenAt: daysAgo(2)
  }
];
