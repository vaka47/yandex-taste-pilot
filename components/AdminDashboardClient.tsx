  ...
  return (
    <>
      ...
      <section className="adminGrid" id="sync">
        ...
        <article className="adminPanel automationPanel"><header><div><span>как работает публикация</span><h2>Без ручных действий</h2></div><Icon name="sync" /></header><ol><li><b>1</b><span>Один фоновый цикл на production-сервере проверяет историю, а открытие страницы может запустить дополнительную неблокирующую проверку.</span></li><li><b>2</b><span>Мы берём треки, которые Яндекс уже добавил в историю. Точную длительность прослушивания Яндекс нам не сообщает.</span></li><li><b>3</b><span>Новая разрешённая запись попадает на страницу, в живой плейлист и — не чаще раза в день — в Telegram-сводку.</span></li></ol><p>Страница всегда открывается из сохранённых данных и не ждёт ответа Яндекса. Ошибки и запуски фиксируются отдельно.</p></article>
      </section>
