...
export default async function HomePage() {
  ...
  return (
    <main className="landingPage">
      ...
      <section className="landingBottom"><span>Новая любимая песня уже играет у вашего Саундмейкера</span><a href="#discover">Найти Саундмейкера <Icon name="arrow" /></a></section>
