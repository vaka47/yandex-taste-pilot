...
export default async function HomePage() {
  ...
  return (
    <main className="landingPage">
      ...
      <section className="landingFlow"><header><span>01—03</span><h2>Один новый трек.<br />Три честных шага.</h2></header><div className="landingSteps"><article><b>01</b><Icon name="music" /><h3>Кумир слушает</h3><p>Только после явного согласия событие попадает в защищённый контур Taste.</p></article><article><b>02</b><Icon name="pulse" /><h3>Taste показывает</h3><p>С учётом задержки, паузы и скрытых треков. Приватность управляется самим автором.</p></article><article><b>03</b><Icon name="playlist" /><h3>Фанат открывает</h3><p>Трек или один постоянный живой плейлист — уже внутри Яндекс Музыки.</p></article></div></section>
      ...
      <footer className="landingFooter"><Brand inverse /><p>Независимый экспериментальный продукт. Не связан с Яндексом и не одобрен им.</p><nav><Link href="/privacy">Приватность</Link><Link href="/creator">Кабинет автора</Link></nav></footer>
    </main>
  );
}
